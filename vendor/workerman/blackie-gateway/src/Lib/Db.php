...
class Db
{
	...
	public static function row($config_name,$sql)
    {
		$rs = array();
		$rs = self::$instance[$config_name]->row($sql);
		return $rs;
	}
	public static function fetchAll($config_name,$sql)
    {
		$rs = array();
		$rs = self::$instance[$config_name]->query($sql);
		return $rs;
